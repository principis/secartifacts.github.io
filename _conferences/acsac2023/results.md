...
-   title: 'Artemis: Defanging Software Supply Chain Attacks in Multi-repository Update Systems'
    badges: functional,reusable,reproduced
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="62px">
        ...
        <img alt="{{ page.reproduced_name }}" src="{{ site.baseurl }}/images/{{ page.reproduced_img }}" width="50px">
        {% endif %}
      </td>
      <td width="62px">
      ...
      <td>
        ...
        <a href="{{artifact.artifact_url}}" target="_blank">
          Artifact
        </a>
        <br>
        {% endfor %}
